...
<body onload="checkifempty()">
	...
	<div id="header" >
		...
		<div class="wrap">
			...
			<h1 id="logotext"><a href="#">FRSASIR</a></h1>
			<ul id="menu" >
				<li><a class="current" href="concurso.php">DHCP</a></li>
				<li><a  href="index.html">DNS</a></li>
				<li><a href="artistas.html">FIREWALL</a></li>
				<li><a href="inscritos.php">USUARIOS</a></li>
				<li ><a class="last" href="contacto.html">Home</a></li>
			...
			<div class="display">
				...
				<div id=form >
					<form action="validar.php"  method="post" id="form1" name="form1">
						<fieldset>
						<legend>
								&nbsp;&nbsp;&nbsp; Configuracion del servidor DHCPD 
								<br>
						</legend>
						<br>                                                                                                                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
